...
export function CookieConsent() {
  ...
  return (
    <aside className="fixed inset-x-3 bottom-3 z-[70] mx-auto max-w-xl rounded-lg border border-neutral-200 bg-white p-4 shadow-2xl sm:bottom-5 sm:p-5" aria-label="Preferencias de cookies">
      <p className="text-sm font-bold text-neutral-950">Privacidad y medición</p>
      <p className="mt-1 text-sm leading-6 text-neutral-600">
        Usamos cookies necesarias para que la tienda funcione. Con tu permiso, medimos visitas y acciones generales sin enviar nombres, correos, teléfonos, direcciones ni otros datos personales a Google.
      </p>
